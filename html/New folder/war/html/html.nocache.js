function html(){
  ...
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['gecko1_8'], '272461CCD7F805C01E117C1CDF23CA71');
      unflattenKeylistIntoAnswers(['safari'], '366B40BD6965710C3B018C941A249EB4');
      unflattenKeylistIntoAnswers(['ie10'], '4787BB8110B20156EE925996FD9B3623');
      unflattenKeylistIntoAnswers(['ie9'], 'C3FF7720720426136DCA80C40A17ED1E');
      unflattenKeylistIntoAnswers(['ie8'], 'C678C2F891BDE1FCDE26D70357411FB3');
